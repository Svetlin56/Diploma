...
void setup() {
  ...
  Serial.println("System start: camera + sensors.");
}
...
void loop() {
  ...
  if (cam.grabFrame(fb, 3000) == 0) {
    ...
    dsi_lcdDrawImage((void*)outfb.getBuffer(), (void*)dsi_getCurrentFrameBuffer(), 480, 640, DMA2D_INPUT_RGB565);
    dsi_drawCurrentFrameBuffer();
  } else {
    Serial.println("Can't process image.");
    blinkLED(3);
  }
